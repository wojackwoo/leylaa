    ...
    <section className="mt-12 border-t border-white/10 pt-12">
      <div className="grid gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:items-end">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="group flex min-h-[220px] w-full flex-col justify-between rounded-[30px] border border-white/10 bg-white/[0.035] p-6 transition-all duration-300 hover:border-white/20 hover:bg-white/[0.06] hover:scale-[1.01] active:scale-[0.99] sm:p-8"
        >
          <div className="flex items-center justify-between">
            <span className="flex h-14 w-14 items-center justify-center rounded-full bg-white text-black">
              <Ticket size={23} />
            </span>
            <span className="text-2xl text-white/25 transition group-hover:-translate-y-1 group-hover:translate-x-1 group-hover:text-white">
              ↗
            </span>
          </div>
